package com.example.familynovaparent.utils;
...
public class Encryption {
    ...
    public static String decrypt(String encryptedText) throws Exception {
        ...
        // Extract actual encrypted data (remove IV from combined data)
        // Format: combined contains [IV][encrypted]
        byte[] actualEncrypted = new byte[combined.length - IV_SIZE];
        System.arraycopy(combined, IV_SIZE, actualEncrypted, 0, actualEncrypted.length);
