...
public class ApiClient {
    ...
    public static Retrofit getClient(Context context) {
        if (retrofit == null) {
            ...
            SharedPreferences prefs = context.getSharedPreferences("FamilyNova", Context.MODE_PRIVATE);
            ...
            OkHttpClient client = new OkHttpClient.Builder()
                    ...
                    .addInterceptor(chain -> {
                        ...
                        SharedPreferences sharedPrefs = context.getSharedPreferences("FamilyNova", Context.MODE_PRIVATE);
